    ...
    for( indice_tabela in 1:quantidade_de_tabelas_na_pagina ){
      ...
      if(quantidade_de_colunas == 8 ){
        if(indice_de_relatorio == 1)
        {
          ...
          delimitador_fim    <- c( largura_total-110 , largura_total-90 , largura_total-70 , largura_total-50 , largura_total-40 , largura_total-22  , largura_total-10 , largura_total        ) 
        }
        if(indice_de_relatorio == 2){
          delimitador_inicio <- c( 10                , largura_total-155, largura_total-134 , largura_total-97 , largura_total-71 , largura_total-50  , largura_total-30 , largura_total - 10  )
          delimitador_fim    <- c( largura_total-160 , largura_total-135 , largura_total-98 , largura_total-72 , largura_total-50 , largura_total-30  , largura_total-10 , largura_total       ) 
        }
        if(indice_de_relatorio == 5){
          delimitador_inicio <- c( 10                , largura_total-180 , largura_total-134 , largura_total -121 , largura_total-81 , largura_total-50  , largura_total-25 , largura_total - 10 )
          delimitador_fim    <- c( largura_total-180 , largura_total-135 , largura_total-120 , largura_total -70 , largura_total-51 , largura_total-26  , largura_total-10 , largura_total + 10 )
        }
        #============================================================
        #  A partir desses relatórtios não foram feitas calibragens
        #============================================================
        if(indice_de_relatorio == 3){
          delimitador_inicio <- c( 10                , largura_total-158 , largura_total-135 , largura_total-94 , largura_total-70 , largura_total-49  , largura_total-25 , largura_total - 10  )
          delimitador_fim    <- c( largura_total-160 , largura_total-130 , largura_total-100 , largura_total-80 , largura_total-50 , largura_total-30  , largura_total-10 , largura_total + 10   ) 
        }
        if(indice_de_relatorio == 4){
          delimitador_inicio <- c( 10                , largura_total-170, largura_total-126 , largura_total-92 , largura_total-65 , largura_total-50  , largura_total-30 , largura_total - 10 )
          delimitador_fim    <- c( largura_total-170 , largura_total-125 , largura_total-93 , largura_total-66 , largura_total-51 , largura_total-31  , largura_total-10 , largura_total + 10 ) 
        }
      ...
      if( quantidade_de_colunas == 5 ){
        if(indice_de_relatorio == 1)
        {
          delimitador_inicio <- c( 10                , largura_total-109 , largura_total-88  , largura_total-70 , largura_total  - 10  )
          delimitador_fim    <- c( largura_total-110  , largura_total-89 , largura_total-70  , largura_total-10 , largura_total        ) 
        }
        if(indice_de_relatorio == 2){
          delimitador_inicio <- c( 10                , largura_total-159 , largura_total-130  , largura_total-99 , largura_total - 10  )
          delimitador_fim    <- c( largura_total-160 , largura_total-131 , largura_total-100  , largura_total-10 , largura_total       ) 
        }
        ...
        if(indice_de_relatorio == 5){
          delimitador_inicio <- c( 10                , largura_total-81 , largura_total-50  , largura_total-25 , largura_total - 10 )
          delimitador_fim    <- c( largura_total-190 , largura_total-51 , largura_total-26  , largura_total-10 , largura_total + 10 )
        }
...
for( indice_de_relatorio in c(1,2,5) )
{
  ...
  numero_da_pagina             <- 8
  inicio_da_tabela_desejada    <- " DO QUEROSENE DE AVIAÇÃO POR PORTO "
...
dataframe_qav  <- data.frame( "indice_df" = 1, resultado_relatorios[[1]][[1]]$Tabela[[1]] )
indice_de_relatorio <- 2
for(indice_de_relatorio in c(2,5)){
  dataframe_qav  <- full_join( dataframe_qav, data.frame( "indice_df" = indice_de_relatorio, resultado_relatorios[[indice_de_relatorio]][[1]]$Tabela[[1]] ) )
...
dataframe_qav$Período <- factor( 
  dataframe_qav$Período, 
  levels = c(
    "jan/15", "fev/15",
    "mar/15", "abr/15",
    "mai/15", "jun/15",
...
dataframe_qav             <- dataframe_qav[ order(dataframe_qav$Período), ]
dataframe_qav_ordenado    <- dataframe_qav[order(dataframe_qav$Período),]
dataframe_qav_final       <- dataframe_qav_ordenado[ -which( duplicated( dataframe_qav_ordenado$Período) ), ]
