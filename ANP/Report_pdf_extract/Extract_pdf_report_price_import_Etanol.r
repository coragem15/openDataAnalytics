    ...
    for( indice_tabela in 1:quantidade_de_tabelas_na_pagina ){
      ...
      if(quantidade_de_colunas == 8 ){
        ...
        if(indice_de_relatorio == 2){
          delimitador_inicio <- c( 10                , largura_total-155, largura_total-134 , largura_total-97 , largura_total-70 , largura_total-50  , largura_total-30 , largura_total - 10  )
          delimitador_fim    <- c( largura_total-160 , largura_total-135 , largura_total-98 , largura_total-70 , largura_total-50 , largura_total-30  , largura_total-10 , largura_total       ) 
        }
        ...
        if(indice_de_relatorio == 3){
          ...
          delimitador_fim    <- c( largura_total-160 , largura_total-130 , largura_total-96 , largura_total-73 , largura_total-50 , largura_total-30  , largura_total-10 , largura_total + 10   ) 
        }
        ...
        if(indice_de_relatorio == 5){
          delimitador_inicio <- c( 10                , largura_total-170, largura_total-130 , largura_total -92 , largura_total-61 , largura_total-50  , largura_total-25 , largura_total - 10 )
          delimitador_fim    <- c( largura_total-170 , largura_total-131 , largura_total-93 , largura_total-62 , largura_total-51 , largura_total-26  , largura_total-10 , largura_total + 10 )
        }
        #============================================================
...
for( indice_de_relatorio in c(1,2,5) )
{
  ...
  numero_da_pagina             <- 5
  inicio_da_tabela_desejada    <- "DO ETANOL POR PORTO"
...
dataframe_etanol  <- data.frame( "indice_df" = 1, resultado_relatorios[[1]][[1]]$Tabela[[1]] )
indice_de_relatorio <- 2
for(indice_de_relatorio in c(2,5) ){
  dataframe_etanol  <- full_join( dataframe_etanol, data.frame( "indice_df" = indice_de_relatorio, resultado_relatorios[[indice_de_relatorio]][[1]]$Tabela[[1]] ) )
...
dataframe_etanol$Período <- factor( 
  dataframe_etanol$Período, 
  levels = c(
    "jan/15", "fev/15",
    "mar/15", "abr/15",
    "mai/15", "jun/15",
...
dataframe_etanol             <- dataframe_etanol[ order(dataframe_etanol$Período), ]
dataframe_etanol_ordenado    <- dataframe_etanol[order(dataframe_etanol$Período),]
dataframe_etanol_final       <- dataframe_etanol_ordenado[ -which( duplicated(dataframe_etanol_ordenado$Período) ), ]


dataframe_etanol_final